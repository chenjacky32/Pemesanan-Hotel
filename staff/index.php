            ...
            <nav class="navbar navbar-expand-md navbar-dark bg-primary">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="?page=sewakamar">Transaksi</a>
                        </li>
                        <li class="nav-item active">
                ...
                <?php
                    if(isset($_GET['page'])) {
                        switch($_GET['page']) {
                            ...
                            break;
                            case 'tambah-customer';
                            include('tambah-customer.php');
                            break;
                            case 'perbarui-customer';
                            include('perbarui-customer.php');
                            break;
                            case 'hapus-customer';
                            include('hapus-customer.php');
                            break;
                            case 'customer-aksi';
                            include('customer-aksi.php');
                            break;
                            case 'history';
                            include('history.php');
                            break;
                            ...
                            break; 
                            case 'sewa-aksi';
                            include('sewa-aksi.php');
                            break;
                            case 'tambah-sewakamar';
                            include('tambah-sewakamar.php');
                            break;
                            case 'hapus-sewakamar';
                            include('hapus-sewakamar.php');
                            break;
                            case 'perbarui-sewakamar';
                            include('perbarui-sewakamar.php');
                            break;
                            case 'pembelian';
